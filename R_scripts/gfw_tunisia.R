...
gfw_rt = read.csv("../www/data/gfw_data.csv")
...
# Save the map
saveWidget(m, "../www/maps/fishing_activity_map.html", selfcontained = FALSE)
saveWidget(m, "../www/maps/fishing_activity_map_sc.html", selfcontained = TRUE)